    ...
    <div class="col-12">
        <div class="card card-default">
            ...
            <form action="<?= base_url('docline/add_licence/');?>" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="licence_name">Licence Name</label>
                                <input class="form-control" type="text" required name="licence_name" value="<?= form_error('licence_name');?>" placeholder="Licence Name">
                            </div>

                            <div class="form-group">
                                <label for="licence_no">Licence Number</label>
                                <input class="form-control" type="text" required name="licence_no" value="<?= form_error('licence_no');?>" placeholder="Licence Number">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" required type="text" name="licence_by" placeholder="Licenced by">  
                            </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
                                <label for="licence_start_date">Start Date</label>
                                <input class="form-control" required type="date" name="licence_start_date" placeholder="Stat Date">  
                            </div>
                            <div class="form-group">
                                <label for="licence_expire_date">Expire Date</label>
                                <input class="form-control" required type="date" name="licence_expire_date" placeholder="Expire Date">  
                            </div>
                            <div class="form-group">
                                <label for="licence_person">Person licenced (Optional)</label>
                                <input class="form-control" type="text" name="licence_person" placeholder="Person holder" >
                            </div>

                            <div class="form-group">
                                <label for="licence_note">Notes</label>
                                <textarea class="form-control" type="text" name="licence_note" placeholder="Notes"></textarea>
                            </div>
                        </div>
                    </div>
