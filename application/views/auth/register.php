		...
		<div class="register-box" style="width: 100%;">
			<div class="card card-outline card-primary">
				<div class="card-header text-center">
					<a href="<?= base_url();?>" class="h1"><b>WINPAD</b>System</a>
				</div>
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<input name="user_username" id="noSpace" class="form-control" onkeyup='lettersOnly(this)' oninput="this.value = this.value.toLowerCase()" value="<?= set_value('user_username'); ?>" type="text" placeholder="Username">
